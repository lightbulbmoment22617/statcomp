...
#' model_Z() constructs the Z-matrices for the example model from Lecture 4.
...
# Note: plotting colours number 1, 2, and 4 are black, red, and blue!
#
# plot(actual ~ cad, data = printer_data)
# for (col_loop in as.character(levels(printer_data$colour))) {
#   points(actual ~ cad,
#          data = printer_data[printer_data$colour == col_loop, ],
#          pch = 20, col = col_loop)
# }
